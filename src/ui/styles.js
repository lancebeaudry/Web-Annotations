...
.toolbar {
  ...
  pointer-events: auto;
  z-index: 30;
  background: rgba(0, 38, 61, 0.88);
  padding: 8px 10px;
  border-radius: 999px;
  box-shadow: 0 8px 28px rgba(0, 38, 61, 0.45);
...
.fab:hover { background: #2a7bb0; }
@keyframes markup-pulse {
  0%, 100% { box-shadow: 0 0 0 0 rgba(155, 227, 255, 0.65); }
  50% { box-shadow: 0 0 0 9px rgba(155, 227, 255, 0); }
}
.fab.active {
  background: #9BE3FF;
  color: #00263D;
...
.fab-secondary {
  ...
  color: #9BE3FF;
  border: 1.5px solid rgba(155, 227, 255, 0.55);
}
.fab-secondary:hover { background: rgba(155, 227, 255, 0.15); color: #fff; }
...
/* keep the toolbar reachable while the sidebar is out */
.layer.sidebar-open .toolbar { right: 360px; }
