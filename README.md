...
## 2.4: references from anywhere (Chrome extension)

- **What**: `extension/` is a Manifest V3 extension ("PinPoint Anywhere"). On any site, pick an element and save it to one of your projects with a note: Chrome takes a pixel screenshot (`chrome.tabs.captureVisibleTab`, cropped to the element), and the picker records the source URL, element text and the computed styles that matter.
