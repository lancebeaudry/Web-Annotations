...
export const updateSettings = async (id, { name, site_url, open_access }) =>
  unwrap(await supabase.rpc('update_project_settings', { p_project: id, p_name: name ?? null, p_site_url: site_url ?? null, p_open_access: open_access ?? null }));
